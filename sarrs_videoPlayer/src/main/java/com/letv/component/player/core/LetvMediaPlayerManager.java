...
public class LetvMediaPlayerManager {
	...
	public int getHardDecodeSupportLevel(){
		...
		if (mConfig.mHardDecodeCapability.isSupport1300k) {
	...
	public int getSoftDecodeSupportLevel(){
		if (mConfig.mSoftDecodeCapability.isSupport1300k) {
	...
	private static void upLog(String path, String fbid) {
	...
	private static List<File> list2(File dir) {
