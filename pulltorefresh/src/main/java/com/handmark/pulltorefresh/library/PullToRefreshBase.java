...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private boolean onlyShowRefreshingHeader = false;
	...
	public final void setOnlyShowRefreshingHeader(boolean show) {
		onlyShowRefreshingHeader = show;
	}
	...
	private final void smoothScrollTo(int newScrollValue, long duration, long delayMillis,
		...
		if (oldScrollValue != newScrollValue) {
			...
			mCurrentSmoothScrollRunnable = new SmoothScrollRunnable(oldScrollValue, newScrollValue, duration, listener, onlyShowRefreshingHeader);
	...
	final class SmoothScrollRunnable implements Runnable {
		...
		//true:不需要执行lister, false:需要执行listener
		private boolean onlyShowRefrehingHeader = false;

		public SmoothScrollRunnable(int fromY, int toY, long duration, OnSmoothScrollFinishedListener listener, boolean showRefrehingHeader) {
			mScrollFromY = fromY;
			mScrollToY = toY;
			mInterpolator = mScrollAnimationInterpolator;
			mDuration = duration;
			mListener = listener;
			this.onlyShowRefrehingHeader = showRefrehingHeader;
		}
		...
		public void run() {
			...
			if (mContinueRunning && mScrollToY != mCurrentY) {
				...
				if (null != mListener && !this.onlyShowRefrehingHeader) {
