...
public interface ShareConstants {
    ...
    public static final int SHARE_TO_FRIEND = SHARE_TO_WEIXIN + 1;

    /**
     * 微信的APP_ID
     */
    // wxd930ea5d5a258f4f//wx9c596e90ce61174a
    // test wx1eee241cc1ddad05
    public static final String WEIXIN_APP_ID = "wxee6e741e4aa127e4";

    public static final String WEIXIN_APP_SECRET = "63d911fb0425499c5517454398da6abb";
    ...
    public static final long T_WEIBO_APP_ID = 801537850;
    public static final String T_WEIBO_SECRET = "e02f44d877ecac9226e6b317fd9e2b2f";

    /**
     * 存放二维码的路径
     */
    public final static String ALBUM_PATH = Environment.getExternalStorageDirectory()
            + "/Infinitemovies/";
